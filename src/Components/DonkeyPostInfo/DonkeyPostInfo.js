    ...
    <div className="DPIWrapper">
      <div className="DonkeyPostInfo">
        ...
        <div className="dChecks">
          <div className="check">
            <div
              className={`customCheck ${type === "Jack" ? "checkTrue" : ""} `}
            ></div>
          ...
          <div className="check">
            <div
              className={`customCheck ${type === "Jenny" ? "checkTrue" : ""} `}
            ></div>
            <label className="checkLabel" htmlFor="">
              Jenny
            </label>
          ...
          <div className="dColors">
            <div className="dColorsLabel">Colors:</div>
            <div className="dColorNames overflowY">{color}</div>
          </div>
        </div>
        ...
        <div className="nameWrapper">
          <div className="dDesc">Description:</div>

          <div className="dDescText overflowY">| {description}</div>
        </div>

        {/* Birth Info */}

        <div className="nameWrapper">
          <div className="birthInfo">Birth Info</div>

          <div className="birthTable">
            <div className="month">
              <div className="monthNum">{month}</div>
              <br />
              <div className="monthLabel">Month</div>
            </div>

            <div className="month">
              <div className="monthNum">{year}</div>
              <br />
              <div className="monthLabel">Year</div>
            </div>

            <div style={{ border: "none" }} className="month">
              <div className="monthNum">{age}</div>
              <br />
              <div className="monthLabel">Age</div>
            </div>
          </div>
        </div>
        ...
        <div className="notes">
          <div className="intakeNotes">Intake Notes</div>

          <div className="notesText overflowY">{notes}</div>
        </div>
